...
def test_protected_route_revoked_token():
    ...
    with patch("firebase_admin.auth.verify_id_token", side_effect=firebase_admin.auth.RevokedIdTokenError(message="Token revoked")):
...
def test_protected_route_expired_token():
    ...
    with patch("firebase_admin.auth.verify_id_token", side_effect=firebase_admin.auth.ExpiredIdTokenError(message="Token expired", cause="test")):
