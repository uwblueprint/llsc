...
import { getEmailForSignIn, clearEmailForSignIn, setEmailForSignIn } from '@/services/firebaseAuthService';
...
export default function VerifyPage() {
  ...
  const { sendVerificationEmail, sendSignInLink, isLoading, error, success } = useEmailVerification();
    ...
    <Flex minH="100vh" direction={{ base: 'column', md: 'row' }}>
      <Flex flex="1" align="center" justify="center" px={{ base: 4, md: 12 }} py={{ base: 16, md: 0 }} bg="white" minH={{ base: '60vh', md: '100vh' }}>
        <Box w="full" maxW="520px">
          ...
          <Text mb={6} color="#1d3448" fontFamily="'Open Sans', sans-serif" fontWeight={400} fontSize="md">
            Didn&apos;t get a link?{' '}
            <Button
              variant="ghost"
              color="#056067"
