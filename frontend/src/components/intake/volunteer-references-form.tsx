                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        fontSize="14px"
                        color={COLORS.veniceBlue}
                        borderColor={errors.reference1?.fullName ? 'red.500' : '#d1d5db'}
                        borderRadius="6px"
                        h="40px"
                        border="1px solid"
                        px={3}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        fontSize="14px"
                        color={COLORS.veniceBlue}
                        borderColor={errors.reference1?.email ? 'red.500' : '#d1d5db'}
                        borderRadius="6px"
                        h="40px"
                        border="1px solid"
                        px={3}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        fontSize="14px"
                        color={COLORS.veniceBlue}
                        borderColor={errors.reference1?.phoneNumber ? 'red.500' : '#d1d5db'}
                        borderRadius="6px"
                        h="40px"
                        border="1px solid"
                        px={3}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        fontSize="14px"
                        color={COLORS.veniceBlue}
                        borderColor={errors.reference2?.fullName ? 'red.500' : '#d1d5db'}
                        borderRadius="6px"
                        h="40px"
                        border="1px solid"
                        px={3}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        fontSize="14px"
                        color={COLORS.veniceBlue}
                        borderColor={errors.reference2?.email ? 'red.500' : '#d1d5db'}
                        borderRadius="6px"
                        h="40px"
                        border="1px solid"
                        px={3}
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        fontSize="14px"
                        color={COLORS.veniceBlue}
                        borderColor={errors.reference2?.phoneNumber ? 'red.500' : '#d1d5db'}
                        borderRadius="6px"
                        h="40px"
                        border="1px solid"
                        px={3}
