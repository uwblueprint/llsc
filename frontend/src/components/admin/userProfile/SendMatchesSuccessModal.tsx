...
interface SendMatchesSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function SendMatchesSuccessModal({
  isOpen,
  onClose,
  participantName,
  matchCount,
}: SendMatchesSuccessModalProps) {
  if (!isOpen) {
    return null;
  }
        ...
        <VStack align="center" gap={5} alignSelf="stretch">
          ...
          <VStack align="center" gap={2} alignSelf="stretch">
            ...
            <Text
              ...
              textAlign="center"
            >
              {matchCount} {matchCount === 1 ? 'match has' : 'matches have'} been sent
              {participantName ? ` to ${participantName}` : ''}. Matches sent, awaiting participant
              response.
            </Text>
          </VStack>
